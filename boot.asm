...
-	lda player_bmp + 64,x ; the mid step
	...
	; draw the plinth
	ldx #1
	stx screen_base + 24*15 + 10
	inx
	stx screen_base + 24*16 + 10
	inx
	stx screen_base + 24*15 + 11
	inx
	stx screen_base + 24*16 + 11

	; draw willy on the plinth
	ldx #11
	stx screen_base + 24*13 + 10
	inx
	stx screen_base + 24*14 + 10
	inx
	stx screen_base + 24*13 + 11
	inx
	stx screen_base + 24*14 + 11
