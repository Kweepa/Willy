...
meta_off_belt = 4
meta_off_ramp = 5
meta_off_ramp_col_start = 6
meta_off_ramp_col_end = 7
meta_off_ramp_row = 8
meta_off_ramp_row_step = 9
meta_off_conn = 10
meta_off_item_draw = 14         ; 11-byte 6502: lda #chr sta scr lda #col sta col rts
meta_off_item_draw_size = 11
meta_size = 25
meta_off_tilecolors = 25
meta_off_guardian_data = 31
