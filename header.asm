...
meta_content_item_draw = meta_content_src + 16    ; 16-byte 6502: lda #chr sta scr lda #col sta col lda #TILE_ITEM sta map rts
meta_content_item_draw_size = 16
meta_content_item_erase = meta_content_src + 32   ; 11-byte 6502: lda #empty_col sta col lda #TILE_EMPTY sta map rts
meta_content_item_erase_size = 11
meta_size = 43
meta_content_room_has_rope = meta_content_src + 43
meta_content_guardian_data = meta_content_src + 44
